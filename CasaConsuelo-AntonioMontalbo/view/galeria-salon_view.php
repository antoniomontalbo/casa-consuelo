            ...
            <div class="galeria">
                ...
                <div class="menu-galeria">
                    <ul class="menu-principal">
                        ...
                        <li><a href="index.php?pagina=salon" style="background-color:#976c4e; box-shadow:3px 3px 8px black;">Salón</a></li>
                        <li><a href="index.php?pagina=exterior">Exterior</a></li>
                    </ul>
                </div>
                <div class="galeria-grid" aria-label="Galería de imágenes">
                    <img src="img/salon1.jpg" alt="Baño">
                    <img src="img/salon3.jpg" alt="Baño">
                    <img src="img/salon2.jpg" alt="Baño">
                    <img src="img/salon4.jpg" alt="Baño">
                </div>
            </div>
