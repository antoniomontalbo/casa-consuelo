            ...
            <div class="galeria">
                ...
                <div class="menu-galeria">
                    <ul class="menu-principal">
                        ...
                        <li><a href="index.php?pagina=exterior" style="background-color:#976c4e; box-shadow:3px 3px 8px black;">Exterior</a></li>
                    </ul>
                </div>
                <div class="galeria-grid" aria-label="Galería de imágenes">
                    <img src="img/exterior1.jpg" alt="Baño">
                    <img src="img/exterior2.jpg" alt="Baño">
                    <img src="img/exterior3.jpg" alt="Baño">
                    <img src="img/exterior4.jpg" alt="Baño">
                </div>
            </div>
